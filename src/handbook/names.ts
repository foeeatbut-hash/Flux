...
export const THING_RU: Record<string, string> = {
  ...
  BlankTemplate: 'шаблон бланка',
  CatalogClass: 'класс оборудования',
  CatalogComponent: 'комплектующее из Каталога',
  CatalogFamily: 'семейство оборудования',
  CatalogLearn: 'выученный выбор подбора',
  CatalogManufacturer: 'производитель',
  CatalogRevision: 'снимок правки Каталога',
  CatalogTagRule: 'правило кода в теге',
  ImportProfile: 'формат таблицы заказчика',
  SelectionBatch: 'отменяемое действие в ведомости',
  SelectionIssue: 'выпуск бланков',
  SelectionItem: 'позиция ведомости подбора',
  SelectionList: 'ведомость подбора',
  ...
  PdfMarkupTransfer: 'отметка о переносе замечания в сам файл',
  Folder: 'папка',
...
export const LINK_RU: Record<string, string> = {
  ...
  classId: 'относится к этому классу оборудования',
  familyId: 'подобрано из этого семейства',
  listId: 'входит в эту ведомость подбора',
  manufacturerId: 'выпускает этот производитель',
  templateId: 'выпускается по этому шаблону',
