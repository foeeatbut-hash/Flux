...
const UNIT_CANON: { canon: string; forms: string[] }[] = [
  ...
  { canon: 'кВ·А', forms: ['ква', 'кв·а', 'кв*а', 'kva', 'kv*a'] },
  ...
  // Единицы теплотехнического расчёта: приходят из выгрузки САПР, а в бланках
  // пишутся от руки и потому в десятке начертаний
  { canon: 'г/кг', forms: ['г/кг', 'g/kg', 'гр/кг'] },
  { canon: 'кДж/кг', forms: ['кдж/кг', 'kj/kg', 'кдж/кгс'] },
  { canon: 'кг/(м²·с)', forms: ['кг/(м2*с)', 'кг/(м²·с)', 'кг/м2с', 'кг/м2*с', 'kg/(m2*s)'] },
  { canon: 'мм рт. ст.', forms: ['ммрт.ст.', 'ммртст', 'мм рт ст', 'мм.рт.ст.', 'mmhg'] },
